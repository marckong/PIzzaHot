  ...
  return (
    <div className='relative overflow-hidden bg-white'>
      <div className='mx-auto max-w-7xl'>
        <div className='relative z-101 bg-white pb-8 sm:pb-16 md:pb-20 lg:w-full lg:max-w-2xl lg:pb-28 xl:pb-32'>


          <main className='mx-auto mt-10 max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28 lg:mr-20'>
            <div className='sm:text-center lg:text-left'>
              ...
              <div className='mt-5 sm:mt-8 sm:flex sm:justify-center'>
                ...
                <div className='mt-3 sm:mt-0 sm:ml-3'>
                  <a
                    href='/chef'
                    className='flex w-full items-center justify-center rounded-md border border-transparent bg-yellow-100 px-8 py-3 text-base font-medium text-black hover:bg-yellow-200 md:py-4 md:px-10 md:text-lg'
                  >
                    Chef
                  </a>
                </div>
